...
interface MagaluInputFormProps {
    inputs: MagaluPricingInputs;
    onInputChange: (field: keyof MagaluPricingInputs, value: string | boolean) => void;
    isBreakeven: boolean;
}

const MagaluInputForm = ({ inputs, onInputChange, isBreakeven }: MagaluInputFormProps) => {
    return (
        <Card className="glass-effect">
            <CardHeader className="pb-4">
                <CardTitle className="flex items-center gap-2 text-lg">
                    <Package className="h-5 w-5 text-purple-600" />
                    Dados do Produto - Magalu
                </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
                ...
                <div className="space-y-4">
                    <div className="space-y-2">
                        <Label htmlFor="shipping-mode">Modalidade de Frete</Label>
                        <Select value={inputs.shippingMode} onValueChange={(value) => onInputChange('shippingMode', value)}>
                            <SelectTrigger>
                                <SelectValue placeholder="Selecione a modalidade" />
                            </SelectTrigger>
                            <SelectContent>
                                <SelectItem value="magalu_envios">Magalu Envios</SelectItem>
                                <SelectItem value="vendedor">Frete por Conta do Vendedor</SelectItem>
                    ...
                    <div className="flex items-center justify-between">
                        <Label htmlFor="free-shipping">Frete Grátis (acima de R$ 99)</Label>
                        <Switch
                            id="free-shipping"
...
export default MagaluInputForm;
